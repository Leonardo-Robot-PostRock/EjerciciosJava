...
import Practica2Relaciones.Ejercicios.Ejercicio3.CajaDeCambios;
import Practica2Relaciones.Ejercicios.Ejercicio3.Llantas;
import Practica2Relaciones.Ejercicios.Ejercicio3.Motor;
import practica1objetos.Ejercicios.Metodos.Imprimible;


public class AutoComposicion implements Imprimible {
    ...
    public AutoComposicion() {
    }

    public AutoComposicion(CajaDeCambios cajaDeCambios, Llantas llantas, Motor motor) {
        this.cajaDeCambios = cajaDeCambios;
        this.llantas = llantas;
        this.motor = motor;
    }

    public AutoComposicion(String marca, String modelo, Motor motor, int puertas, int asientos, int velocidadMaxima, int velocidadActual) {
        this.marca = marca;
        this.modelo = modelo;
        this.motor = motor;
